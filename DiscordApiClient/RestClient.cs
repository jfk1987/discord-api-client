...
namespace DiscordApiClient
{
    public class RestClient
    {
        ...
        private readonly DiscordClientConfig _configuration;
        ...
        public RestClient(DiscordClientConfig configuration)
        {
            _configuration = configuration;
            _client = new HttpClient();
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", "Bot" + _configuration.ApiKey);
